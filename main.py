...
from app.routers import users, sessions, dashboard, settings as settings_router, suggestions, gemini as gemini_router, tasks, blocklist, notes
...
app.include_router(gemini_router.router)   # ← Gemini AI
